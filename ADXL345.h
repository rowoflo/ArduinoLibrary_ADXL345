/*
 ...
 DESCRIPTION:
    This class is used to interface the Arduino with the ADXL345 Digital 3-Axis 
...
public:
    ...
    //--------------------------------------------------------------------------
    // Assignment operator
    const ADXL345& operator=(const ADXL345& rhsObj);
    ...
    void rollPitch(double& theta, double& phi);    
...
private:
    ...
    // Lifecycle
    //--------------------------------------------------------------------------
    void copyHelper(const ADXL345& srcObj);
